...
<?php 
	...
	try {
      ...
      echo '<br><br><a href="http://localhost/prototype/get_userinfo.php"> Get User Info </a>';

    	echo '<br><a href="http://localhost:8080/auth/realms/prototype/protocol/openid-connect/logout?redirect_uri=http://localhost/prototype/logout_callback.php"> Logout </a>';
	}
	catch(Exception $ex) {
  		$code = $ex->getCode();
